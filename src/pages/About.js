    ...
    <div>
      ...
      <div className='max-width about-block animate'>
        ...
        <div className='max-width-inner about-content'>
          ...
          <p>Joined the boot camp of Zuitt for Full Stack Web Developer. Learned to build web applications using the MERN stack. With the help of Zuitt and some self-learnings, develop the following skills:</p>
          <Skills />
